...
//With multiple slices, it is best practice to make actions change only one slice at a time.
//the action's 'type' pattern should be 'sliceName/actionDescriptor'
